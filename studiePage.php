...
<div id="contentAndRssContainer">
    ...
    <div id="contentAndRssContainer">
        <div id="navBarWhithoutRss">
            <ul>
                <li id="usingPage"><a href="studiePage.html">Opleidingen</a></li>
        ...
        <div id="contentContainerFullWidth">
            ...
            <div class="imgOrTextContainer">
                ...
                <p>
                    Als front-end ontwikkelaar ben je verantwoordelijk voor de technische voorkant van een website,
                    applicatie of programma. Jij zorgt ervoor dat het programma er niet
                    alleen goed uit ziet, maar ook echt werkt. Je houdt je bezig met het ontwerpen, programmeren, testen
                    en implementeren van het front-end gedeelte van een toepassing.
                    Zowel op het gebied van de technische aspecten als op het gebied van gebruiksmogelijkheid en
                    toegankelijkheid.
                </p>
                <h1>Cloud</h1>
                <p>
                    Cloud computing is simpel gezegd het verhuizen van software en documenten van een computer naar het
                    internet. Cloud computing is in de laatste jaren sterk gegroeid.
                    Tegenwoordig zijn er dan ook steeds meer applicaties die alleen nog via het internet te bereiken
                    zijn en niet gedownload kunnen worden.
                </p>
                <h1>Technical IT</h1>
                <p>
                ...
                <h1>Software development</h1>
                <p>
                    Software ontwikkelen voor eindgebruikers in een professionele programmeertaal, het integreren van de
                    cloud binnen de IT-werkzaamheden van je organisatie.
            ...
            <div class="imgOrTextContainer">
                ...
                <h1>High Tech System</h1>
                <p>
                    Binnen de opleiding High Tech Systems werk je met multidisciplinaire teams samen met bedrijven aan
                ...
                <h1>Composite design</h1>
                <p>
                    Als student van de composite design opleiding ga je bezig met technische elementen van hoge
                    kwaliteit.
                    De kerncompetentie van een samengesteld ontwerp ligt vooral in de hechting van verschillende
                    high-tech materialen.
                </p>
                <h1>Sustainable polymers</h1>
                <p>
                    Biologisch afbreekbare verpakkingen en frisdrankflessen gemaakt uit planten is realiteit geworden.
                    Wil jij nieuwe biopolymeren ontwikkelen, duurzame prototypes 3D-printen of onderzoek doen naar de
                    recyling van kunststofproducten?
